...
//          Log.i("testre","请插入集团手机卡");
//            return;
//
//        }
//        if (!ConmonUtils.hasSimCard()) {
//          Log.i("testre","请检查集团手机卡是否就绪或者更换卡槽位置");
...
////        MProgressDialog.dismissProgress();
////        finish();
//////      Log.i("testre",ConstantApi.LOG_I_, "==" + sb.toString().trim());
////       Log.i("testre","==" + SMSCore.PhoneNumber);
////
////    }
//
