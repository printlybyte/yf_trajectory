package com.caitiaobang.core.app.tools;

/**
 * ============================================
 * 描  述：
 * 包  名：com.caitiaobang.core.app.tools
 * 类  名：MultipleStatusView
 * 创建人：liuguodong
 * 创建时间：2019/6/29 22:07
 * ============================================
 **/
...
@SuppressWarnings("unused") public class MultipleStatusView extends RelativeLayout {
    ...
    public final void showEmpty(View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (null == mEmptyView) {
            ...
            View empty_view_tv = mEmptyView.findViewById(R.id.empty_view_tv);
            if (null != mOnRetryClickListener && null != emptyRetryView) {
                emptyRetryView.setOnClickListener(mOnRetryClickListener);
                empty_view_tv.setOnClickListener(mOnRetryClickListener);
            }  if (null != mOnRetryClickListener && null != empty_view_tv) {
                empty_view_tv.setOnClickListener(mOnRetryClickListener);
            }
