...
public class StackedAvatarLayout extends ViewGroup {
    ...
    //在new的时候会调用此方法
    public StackedAvatarLayout(Context context) {
        super(context);
        this.context = context;
    }

    public StackedAvatarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public StackedAvatarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
