package com.caitiaobang.core.app.tools.image.image_stacking;

/**
 * ============================================
 * 描  述：
 * 包  名：com.caitiaobang.core.app.tools.image.image_stacking
 * 类  名：FlowLayout
 * 创建人：liuguodong
 * 创建时间：2019/7/16 12:46
 * ============================================
 **/
...
public class StackedAvatarLayoutSmail extends ViewGroup {
    ...
    //在new的时候会调用此方法
    public StackedAvatarLayoutSmail(Context context) {
        super(context);
        this.context = context;
    }

    public StackedAvatarLayoutSmail(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public StackedAvatarLayoutSmail(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            Collections.reverse(lineViews);
    ...
    public void setOneUrls(int  urlVal) {
    ...
    private void setViews() {
        ...
        for (int i = 0; i < allUrls.size(); i++) {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(context).inflate(R.layout.item_praise_smail, this, false);

            Glide.with(context)
                    .load(allUrls.get(i))
                    .transform(new CenterCrop(context), new GlideRoundTransform(context, 5)).placeholder(R.mipmap.ic_more)
