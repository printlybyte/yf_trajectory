 ...
 * 从底部滑上来的popup
 */
public class SlideFromBottomPopup_ios_2 extends BasePopupWindow implements View.OnClickListener {


    public SlideFromBottomPopup_ios_2(Context context) {
        super(context);
    ...
    public View onCreateContentView() {
        return createPopupById(R.layout.popup_slide_from_bottom_ios_2);
    }

    private void bindEvent() {
        findViewById(R.id.popup_slide_from_bottom_ios_2_btn2).setOnClickListener(this);
        findViewById(R.id.popup_slide_from_bottom_ios_2_btn1).setOnClickListener(this);
        findViewById(R.id.popup_slide_from_bottom_ios_2_cencel).setOnClickListener(this);
    ...
    public void onClick(View v) {
        int i = v.getId();
        int selectedPos = 0;
        if (i == R.id.popup_slide_from_bottom_ios_2_btn1) {
            selectedPos = 1;
        } else if (i == R.id.popup_slide_from_bottom_ios_2_btn2) {
            selectedPos = 2;
